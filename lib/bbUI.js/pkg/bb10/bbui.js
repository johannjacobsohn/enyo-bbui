...
console.log("!", !(titleBar.actionButton && !titleBar.backButton) && (titleBar.hasAttribute('data-bb-img') || titleBar.hasAttribute('data-bb-accent-text')))
    ...
    apply: function(elements) {
		...
		for (i = 0; i < elements.length; i++) {
			...
			if (items.length > 0 ) {
				...
				console.log(outerElement, table, items[0])
				try{
